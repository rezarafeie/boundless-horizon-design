...
DROP POLICY IF EXISTS "Allow public upload to manual payment receipts" ON storage.objects;
DROP POLICY IF EXISTS "Allow public read of manual payment receipts" ON storage.objects;
DROP POLICY IF EXISTS "Allow public delete of manual payment receipts" ON storage.objects;
