...
const translations = {
  en: {
    ...
    'faq.answer3': 'Lite for regular use with basic locations, Pro for business with global access and high-speed connections.',
  ...
  fa: {
    ...
    'faq.answer3': 'لایت برای استفاده عادی با مکان‌های محدود، پرو برای کسب‌وکار با دسترسی جهانی و اتصالات پرسرعت.',
