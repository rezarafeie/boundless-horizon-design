    ...
    try {
      ...
      if (!canCreate) {
        ...
        toast({
          ...
          description: language === 'fa' ? 
            'شما قبلاً تست رایگان دریافت کرده‌اید یا درخواست مشابهی در حال پردازش است. لطفاً پس از ۳ روز مجدداً تلاش کنید.' : 
            'You have already received a free trial or a similar request is being processed. Please try again after 3 days.',
          variant: 'destructive',
        });
        return;
      }
